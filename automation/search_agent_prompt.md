...
**Location handling:** The script defaults to `United States`. For city/state-specific queries, pass the location:
```bash
./automation/serpapi_search.sh "Director of QA" "[Your City], [Your State]"
```
